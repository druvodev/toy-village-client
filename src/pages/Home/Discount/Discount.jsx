...
const Discount = () => {
  return (
    <div className="h-[700px] flex items-center  bg-cover bg-center bg-[url('https://media.istockphoto.com/id/499661682/photo/yellow-school-bus-toy-model-in-christmas-theme.jpg?s=612x612&w=0&k=20&c=pCVZO1Z0lhx23JMbs4nYMPE-LtoKQAwDkvKqwVBLMyA=')] my-12">
      <div className="h-full bg-opacity-70 bg-white rounded-r-full flex items-center w-1/2">
        <div className="px-40 py-10 text-center mx-auto">
