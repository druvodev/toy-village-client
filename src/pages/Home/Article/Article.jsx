...
const Article = () => {
  return (
    <div className=" px-5 sm:px-10 py-12 bg-emerald-50">
      <h2 className="text-5xl font-bold text-center">We Write to READ</h2>
      <div className="grid lg:grid-cols-5 gap-3 mt-5 max-w-7xl mx-auto">
        <div className="lg:col-span-3">
          <img
            ...
            alt=""
          />
          <h3 className="text-3xl font-semibold mt-5 mb-1">
          ...
          <div className="text-xl font-semibold opacity-70 flex gap-3 mt-4">
        ...
        <div className="grid gap-3 col-span-2">
          <div>
            <img
              ...
              alt=""
            />
            <h3 className="text-2xl font-semibold mt-5 mb-1">
              Baby Planet's toys makes learning simple!
            </h3>
            <hr />
            <p className="text-lg mt-2">
